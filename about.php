...
<head>
	...
	<style type="text/css">
		* { font-family:"標楷體"; margin-left:auto; margin-right:auto;}
		...
		h2 {color:#1F456E; font-size:40px;}
	</style>
		...
		function change2() {
  			...
  			document.getElementById("h2text").innerText = "Li-Yi Hui";
		}
	</script>
...
<body>
   <table width="70%">
    ...
    <table width="70%" border="1">
      <tr>
    	<td>
	       個人網頁：<a href="file:///D:/mis2026b.html">file:///D:/mis2026b.html</a><br>
	       E-Mail:<a href="mailto:alice2005921@gmail.com">alice2005921@gmail.com</a><br>
